...
mu = 1/2(concentration1*(charge1)**2 + concentration2*(charge2)**2) 

sqrtmu = math.sqrt(mu) 
activitycoefficienta = 10**(-0.51*(charge1**2)*(sqrtmu1))/(1+alpha1*(sqrtmu1)/radius1) 
activitycoefficientb = 10**(-0.51*(charge2**2)*(sqrtmu1))/(1+alpha2*(sqrtmu1)/radius2) 
